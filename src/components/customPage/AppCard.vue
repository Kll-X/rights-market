<template>
    <div class="appcard">
        ...
        <div class="content">
            ...
            <div class="price">
                <span class="price-current">抄底价:{{(info.currentPrice/100).toFixed(0)}}元</span>
                <span class="price-origin">（<span class="line-through">原价:{{(info.originPrice/100).toFixed(0)}}元</span>）</span>
            </div>
        </div>
